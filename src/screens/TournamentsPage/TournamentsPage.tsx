          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            <div className="text-center">
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <h3 className="text-lg font-bold text-[#6F6F6F] mb-3">Multiple Skill Levels</h3>
                <p className="text-[#6F6F6F]">Competitive, Advanced, and Intermediate divisions</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <h3 className="text-lg font-bold text-[#6F6F6F] mb-3">Saturday Events</h3>
                <p className="text-[#6F6F6F]">All tournaments are scheduled on Saturdays</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <h3 className="text-lg font-bold text-[#6F6F6F] mb-3">Multiple Locations</h3>
                <p className="text-[#6F6F6F]">Events across different venues to maximize participation</p>
              </div>
            </div>
            ...
            <div className="text-center">
              <div className="bg-gray-50 p-8 rounded-lg">
                ...
                <h3 className="text-lg font-bold text-[#6F6F6F] mb-3">Competitive Balance</h3>
                <p className="text-[#6F6F6F]">Neck and neck competition throughout the day</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-[1280px] mx-auto px-4 mb-16 md:mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-20 md:mb-28">
            ...
            <div className="flex flex-col justify-center">
              <h3 className="text-2xl md:text-3xl font-bold text-[#6F6F6F] mb-6">About our tournaments</h3>
              <ul className="space-y-3 text-[#6F6F6F] text-base md:text-lg mb-8">
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>Our tournaments offer Competitive, Advanced, and Intermediate skill levels</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                ...
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>Sign-ups for tournaments are limited to the size of the location</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
                  <span>Some tournaments take place over two different locations, formatted by division</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">•</span>
