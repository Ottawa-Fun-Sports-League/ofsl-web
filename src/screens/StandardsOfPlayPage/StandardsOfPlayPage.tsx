        ...
        <div className="mb-16">
          ...
          {activeTab === "womenElite" && (
            <div className="border border-gray-200 rounded-md p-6">
              <div className="space-y-8">
                <section>
                  <h3 className="text-2xl font-bold text-[#6F6F6F] mb-2">Women‚Äôs Elite Volleyball League</h3>
                  <p className="text-lg text-[#6F6F6F]">
                    The OFSL Women‚Äôs Elite Volleyball League is committed to advancing the performance and personal growth of volleyball athletes, where top athletes compete at the highest level. These teams showcase advanced technique, tactical awareness, and exceptional physical endurance in every match.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-2">
                    ...
                    <li>Sets 1‚Äì4 are played to 25 points (hard cap at 25) for tiers in Public Schools. For facilities that are not in Public Schools, the game will play to 25 (with a hard cap of 27).</li>
                    <li>The 5th set is played to 15 points (hard cap) or time cap, whichever comes first.</li>
                    <li>Playoffs: Sets 1‚Äì4 to 25 points (27-point hard cap); 5th set to 15 points (17-point hard cap).</li>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-2">
                    ...
                    <li>When playing with 5 players: must always have 3 players in the front row; must identify starting positions, including a ghost player position; when the ghost player‚Äôs rotation reaches service, the team loses that point; a libero cannot be used if a ghost player is in play.</li>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-2">
                    ...
                    <li>Sub players should wear jerseys that are similar in color to the team‚Äôs.</li>
            ...
            <div className="border border-gray-200 rounded-md p-6">
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-1">
                    <li>Tier 1: 8:00 ‚Äì 10:00 PM</li>
                    <li>Tier 2: 6:00 ‚Äì 8:00 PM</li>
                    <li>Tier 3: 4:00 ‚Äì 6:00 PM</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <p className="text-lg text-[#6F6F6F]">If the match result is tied (e.g., 24‚Äì25 / 25‚Äì24), teams play one additional point to determine which team advances.</p>
                </section>
              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-1">
                    ...
                    <li>A minimum of 2 female players is required. Extra female players are allowed, but must play under the ‚Äúmale rules/position‚Äù guideline.</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-1">
                    ...
                    <li>Extra female players on the court must still follow the ‚Äúguy rules/position‚Äù guideline.</li>
                  </ul>
                </section>
              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-1">
                    ...
                    <li>Minimum of 2 female players on court. Additional females allowed, but extras must play under the ìguys' rules/positionî</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-1">
                    ...
                    <li>Extra girls on the court still must follow the ìguy rules/positionî guideline </li>
                  </ul>
                </section>
                ...
                <section>
                  <h4 className="text-xl font-semibold text-[#6F6F6F] mb-2">Womenís Elite &amp; Women's Premiere</h4>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-1">
                    <li>Tier 1: 8:00 ñ 10:00 PM</li>
                    <li>Tier 2: 6:00 ñ 8:00 PM</li>
                    <li>Tier 3: 4:00 ñ 6:00 PM</li>
                  </ul>
                  ...
                  <p className="text-lg text-[#6F6F6F]">If the match result is tied (e.g., 24ñ25 / 25ñ24), teams play one additional point to determine which team advances.</p>
                </section>
              </div>
            </div>
          )}
