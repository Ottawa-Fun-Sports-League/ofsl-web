...
const FILTER_OPTIONS: FilterOption[] = [
  ...
  // Status filters
  { key: 'activePlayer', label: 'Active Player', category: 'status', description: 'Part of a team' },
  { key: 'playersNotInLeague', label: 'Not in League', category: 'status', description: 'Not in active leagues' },
];
