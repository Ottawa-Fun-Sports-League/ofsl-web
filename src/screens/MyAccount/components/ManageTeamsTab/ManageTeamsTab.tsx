  ...
  const fetchAllTeams = async () => {
    try {
      ...
      const transformedTeams: Team[] = (data || []).map(team => ({
        ...
        captain_name: (team.users as { name: string | null; email: string | null } | null)?.name || 'Unknown',
        captain_email: (team.users as { name: string | null; email: string | null } | null)?.email || 'Unknown',
