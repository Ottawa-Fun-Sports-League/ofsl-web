    ...
    <div className="bg-white border border-gray-200 rounded-lg p-4 mb-6 hidden md:block">
      ...
      >
        <div className="flex items-center gap-4">
          <div className="flex items-center gap-2">
            ...
            <h3
              className="text-lg font-medium text-[#6F6F6F] m-0 p-0"
              style={{ lineHeight: "1" }}
            >
              Search & Filters
            </h3>
        ...
        <div className="flex items-center gap-4">
          <span
            className="text-sm text-[#6F6F6F] m-0 p-0"
            style={{ lineHeight: "1" }}
          >
            ({filteredGymCount} of {gymCount})
          </span>
          {isAnyFilterActive && (
            <Button
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-6">
          <label className="text-sm font-medium text-[#6F6F6F] min-w-[100px]">
            Status:
          </label>
