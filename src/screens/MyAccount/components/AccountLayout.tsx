  ...
  return (
    <div className="bg-white w-full min-h-screen">
      <div className="max-w-[1280px] mx-auto px-4 py-8">
        ...
        {/* Navigation Tabs - Option D: Enhanced Current Style */}
        <div className="border-b border-gray-200 mb-8">
          <div className="flex flex-nowrap overflow-x-auto scrollbar-thin pb-0">
            {/* User Tabs */}
            <Link
              to="/my-account/teams"
              className={`group flex items-center gap-3 px-8 py-4 text-center cursor-pointer relative transition-all duration-300 whitespace-nowrap ${
                isActive('/my-account/teams') 
                  ? 'text-[#B20000] font-semibold' 
                  : 'text-gray-600 hover:text-[#B20000] font-medium'
              }`}
            >
              <div className={`flex items-center justify-center w-8 h-8 rounded-lg transition-all duration-300 ${
                isActive('/my-account/teams') 
                  ? 'bg-[#B20000]/10 text-[#B20000]' 
                  : 'bg-gray-100 text-gray-500 group-hover:bg-[#B20000]/10 group-hover:text-[#B20000]'
              }`}>
              ...
              {isActive('/my-account/teams') && (
                <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#B20000] to-[#8A0000] rounded-full"></div>
              )}
            </Link>
            ...
            {/* Admin Tabs with Visual Separator */}
            {userProfile?.is_admin && (
              <>
                ...
                <Link
                  ...
                  className={`group flex items-center gap-3 px-6 py-4 text-center cursor-pointer relative transition-all duration-300 whitespace-nowrap ${
                ...
                >
                  ...
                  <span className="text-sm">Waivers</span>
                  {isActive('/my-account/waivers') && (
                    <div className="absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r from-[#B20000] to-[#8A0000] rounded-full"></div>
                  )}
                </Link>
