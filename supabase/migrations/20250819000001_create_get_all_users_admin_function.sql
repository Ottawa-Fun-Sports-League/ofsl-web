-- Create or replace the get_all_users_admin function to include all necessary fields
-- This function is used by admins to fetch all users including auth-only users
