          ...
          {activeTab === "wednesday4x4" && (
            <div className="border border-gray-200 rounded-md p-6">
              <div className="space-y-8">
                ...
                <section>
                  <h4 className="text-xl font-semibold text-[#6F6F6F] mb-2">Women+ÛGÈºG‰Ûs Elite &amp; Women's Premiere</h4>
              ...
              <div className="space-y-8">
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 text-lg text-[#6F6F6F] space-y-1">
                    ...
                    <li>A minimum of 2 female players is required. Extra female players are allowed, but must play under the G+‚¶∆+ÛGÈº-Ì+‚G«‹+È-˙male rules/positionG+‚¶∆+ÛGÈº-Ì+‚G«‹+È-— guideline.</li>
                  </ul>
                </section>
          ...
          {activeTab === "rules4x4" && (
            <div className="border border-gray-200 rounded-md p-6">
              <div className="space-y-8">
                ...
                <section>
                  <h4 className="text-xl font-semibold text-[#6F6F6F] mb-2">Sunday Format</h4>
                  <p className="text-lg text-[#6F6F6F]">See the G+‚¶∆+ÛGÈº-Ì+‚G«‹+È-˙Sunday Mixed VolleyballG+‚¶∆+ÛGÈº-Ì+‚G«‹+È-— tab for detailed Sunday evening format and movement rules.</p>
                </section>
              </div>
            </div>
          )}
